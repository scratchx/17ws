/****
Spotify
originally wriiten by  Eric Rosenbaum and placed in ScratchX samples.
https://ericrosenbaum.github.io/spotify-extension/
translated and modified by N. Kishi for hiratoki workshop, August 2017.
****/
(function(ext) {
...
var table = { 'トラック':'track', 'アーティスト':'artist',
     'アルバム':'album', '全部':'full'};

        ext.trackData = function(dataType) {
            temp = table[dataType];
console.log("traceDate "+temp);
...
/**** block name in Japanese *****/
             ['w', ' %s を含む曲を再生', 'searchAndPlay', 'さくら'],
              ['w', ' %s を含む曲を最後まで再生', 'searchAndPlayAndWait', 'lauryn hill'],
              ['r', ' 曲の情報 %m.trackData ', 'trackData', '全部'],
              [' ', ' 次の1ビートを再生', 'playNextBeat'],
              [' ', ' 次の %n ビートを再生', 'playBeat', 4],
              ['w', ' 次の %n ビートを最後まで', 'playBeatAndWait', 4],
              ['r', ' 現在のビート', 'currentBeat'],
              ['h', ' 1ビート再生したとき', 'everyBeat'],
              ['h', ' 4ビート再生したとき', 'everyBar'],
              [' ', ' 再生を止める', 'stopMusic']
